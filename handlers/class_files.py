...
from database.db import get_all_files, get_file_by_id
...
async def send_selected_file(call: CallbackQuery):
    ...
    # Har doim rasm sifatida yuborish (chunki bazadagilar rasmlar)
    try:
        ...
        # Agar rasm bo'lib chiqmasa, hujjat sifatida urinib ko'radi
